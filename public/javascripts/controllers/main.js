...
angular.module('BookHotelApp')
    .controller('MainCtrl',['$scope', '$upload', '$http', 'Hotel','AuthenticationService', '$alert', mainController]);

function mainController($scope, $upload, $http, Hotel, AuthenticationService, $alert, USER_ROLES) {
